...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
    <div class="container-fluid">
        <!-- Brand -->
        <a class="h1 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo e(route('home')); ?>">Kampus NF</a>
        <!-- Form -->
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    <div class=" dropdown-header noti-title">
                        <h6 class="text-overflow m-0"><?php echo e(__('Assalamualaikum')); ?></h6>
                    </div>
...
</nav><?php /**PATH /home/luqni/projek-task-manajer-rma/resources/views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>