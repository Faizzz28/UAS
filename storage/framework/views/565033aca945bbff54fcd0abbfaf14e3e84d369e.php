        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="text-muted text-center mt-2 mb-3"><?php echo e(__('Sign in')); ?></div>
                        <div class="text-center text-muted mb-4">
                            ...
                            <br>
                            <small>
                                <?php echo e(__('Username')); ?> <strong>admin@unf.ac.id</strong>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg-default'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luqni/projek-task-manajer-rma/resources/views/auth/login.blade.php ENDPATH**/ ?>