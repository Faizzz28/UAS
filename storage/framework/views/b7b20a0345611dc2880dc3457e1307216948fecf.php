            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="<?php echo e(route('home')); ?>">
                        ...
                        <span class="nav-link-inner--text">Cyber Campus</span>
                    </a>
                </li>
                <li class="nav-item">
...
</nav><?php /**PATH /home/luqni/projek-task-manajer-rma/resources/views/layouts/navbars/navs/guest.blade.php ENDPATH**/ ?>